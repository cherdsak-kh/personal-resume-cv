...
export const personalInfo = {
  ...
  summary: {
    en: "Hi, I'm Benz (Cherdsak). Throughout my career—from my time in military service to my transition into tech—I have consistently worked full-time while pursuing higher education. I began by studying law, but once I discovered my true passion for technology, I chose to start anew with a Computer Science degree while simultaneously diving into hands-on IT and development roles. Starting in IT Operations and technical support gave me a firsthand appreciation for how essential stable, intuitive systems are for end users. As I moved into full-stack web development across frontend and backend, that perspective remained central to my work: I build applications to solve practical problems. To me, learning is never too late and never stops. I am eager to bring my dedication, work ethic, and experience to lighten the team's workload, serve as a dependable teammate, and help ensure operations run as smoothly as possible.",
    th: "สวัสดีครับ ผมเบนซ์ครับ ตลอดชีวิตการทำงานของผม ไม่ว่าจะช่วงรับราชการทหารหรือก้าวเข้าสู่สายงานไอที ผมเป็นคนที่ทำงานประจำควบคู่ไปกับการศึกษาต่อมาโดยตลอด ตั้งแต่ช่วงที่เรียนนิติศาสตร์ จนกระทั่งค้นพบความชอบที่แท้จริงในสายเทคโนโลยี จึงตัดสินใจเริ่มเรียน ป.ตรี วิทยาการคอมพิวเตอร์ใหม่ พร้อมกับลงมือทำงานจริงในสายงานนี้ไปพร้อมกัน การเริ่มต้นจากงานซัพพอร์ตไอทีและดูแลระบบ ทำให้ผมเข้าใจความรู้สึกของคนใช้งานจริงว่าระบบที่เสถียรและใช้ง่ายสำคัญแค่ไหน พอขยับมาพัฒนาเว็บ ทั้งหน้าบ้านและหลังบ้าน ผมจึงตั้งใจเขียนระบบที่แก้ปัญหาได้ตรงจุดและใช้งานได้จริงเสมอ สำหรับผม การเรียนรู้ไม่มีคำว่าสายและไม่มีที่สิ้นสุดครับ ผมพร้อมนำความตั้งใจและประสบการณ์ที่มี มาช่วยแบ่งเบาภาระงาน เป็นคนที่ทีมไว้ใจได้ และช่วยให้งานในบริษัทดำเนินไปได้อย่างราบรื่นที่สุดครับ"
  },
